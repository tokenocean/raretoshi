      ...
      <label class="inline-flex items-center">
        ...
        <span class="tooltip">
          ...
          <span class="tooltip-text bg-gray-100 shadow ml-4 rounded">
            Setting royalty recipients involves transferring the artwork to a
            2-of-2 multisig address with us. Our server will co-sign on
            transfers if the buyer pays the specified royalty to each recipient.
          </span>
        </span>
      </label>
    </div>
